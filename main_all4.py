...
def main (args):
  ...
  for i in range(time):
    # Load data and introduce missingness
    ori_data_x, miss_data_x, data_m, y  = data_loader3(data_name, miss_rate, i)# 7) #i) block i 
    ...
    imp_mf   = IterativeImputer(estimator = ExtraTreesRegressor(), max_iter = 1, initial_strategy= 'most_frequent', n_nearest_features = 3) #20
    ...
    imp_mice = IterativeImputer(estimator = BayesianRidge(), max_iter = 1, initial_strategy= 'most_frequent', n_nearest_features = 3)# 'mean') #20
