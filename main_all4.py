...
if __name__ == '__main__':  
  ...
  parser.add_argument(
      '--data_name',
      choices=['obesity', 'hepatitisC', 'audit','letter','spam', 'breast', 'credit', 'news','blood','vowel','ecoli','ionosphere','parkinsons','seedst','vehicle','vertebral','wine','banknote','balance','yeast','bean','shill','phishing','firewall'],
      default='spam',
      type=str)
  parser.add_argument(
      '--miss_rate',
